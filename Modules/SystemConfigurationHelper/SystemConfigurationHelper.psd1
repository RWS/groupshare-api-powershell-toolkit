@{
    ...
    Description = 'A PowerShell module for manipulating servers and containers and retrieving license info from a groupshare server using the Rest Api'
    ...
    FileList = @(
        '.\SystemConfigurationHelper.psm1'
        '.\SystemConfigurationHelper.psd1'
    )
